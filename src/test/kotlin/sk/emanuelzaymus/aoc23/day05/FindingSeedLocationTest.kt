...
class FindingSeedLocationTest {
    ...
    @Test
    fun `findLowestLocationNumber - without seed ranges - should return correct result`() {
    ...
    @Test
    fun `findLowestLocationNumber - with seed ranges - should return correct result`() {
